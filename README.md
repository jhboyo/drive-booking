...
| Phase | 역할 | 알고리즘 |
|-------|------|----------|
| **Phase 1** | 필수 4개 질문으로 최적 차량 추천 | Q-Learning |
| **Phase 2** | 고객 선호 + 센터 가용성 기반 일정 배정 | DQN |
...
### Phase 1: 차량 추천 (Q-Learning)

**State**
| 구성 요소 | 차원 | 설명 |
|-----------|------|------|
| 고객 정보 | 5 | 나이, 성별, 외국인, 직장인, 관심차량 유무 |
| 질문 응답 | 40 | 8개 질문 × 5개 옵션 (one-hot 인코딩) |
| 질문 횟수 | 1 | 현재까지 질문 수 / 최대 질문 수 |
| 차량 점수 | 23 | 23종 차량별 매칭 점수 |
...
| 구성 요소 | 차원 | 설명 |
|-----------|------|------|
| 고객 선호도 | 6 | 선호 날짜, 시간대, 유연성 |
| 슬롯 가용성 | 126 | 21일 × 6슬롯 (09:00~18:00) |
| 차량 가용성 | 23 | 23종 차량별 가용 여부 |
| 메타 정보 | 4 | 대기 요청 수, 현재 부하율 등 |
...
> 📄 상세 설계는 [MDP_DESIGN.md](./docs/MDP_DESIGN.md) 참조
